createDataset <- function(dim_x,dim_y,image_list,tipo_superficie){
  #----------------COSTRUZIONE DATASET------------------#
  #In questa versione dello script si costruisce il database prendendo TUTTE LE BANDE:
  #Per la vegetazione:
  ...
  #Man mano aggiungo tutte le bande come sopra
  if(tipo_superficie=="all"){
    ...
    stop("Per la creazione del dataset, la variabile \"tipo_superficie\" può essere solo: \"all\".")
  }
